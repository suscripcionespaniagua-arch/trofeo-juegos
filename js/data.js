...
const GAMES = [
...

  {
    ...
    color: "#1b7a8c",
    resumen:
      "Un Ezio Auditore ya entrado en años viaja a Constantinopla para recuperar las cinco llaves de la biblioteca secreta de Altaïr, mientras Desmond revive los recuerdos fragmentados de Clay Kaczmarek para escapar de su propia mente. El juego introduce la Bomba de mano artesanal y el gancho de escalada. A diferencia de Brotherhood, el platino NO exige el multijugador competitivo: solo pide completar la campaña principal y las secuencias de Desmond, alcanzar el 100% de sincronización, varios coleccionables y desafíos secundarios, y terminar The Lost Archive, la precuela de Desmond incluida de forma gratuita que aporta 10 de los 50 trofeos.",
    perdibles: [],
    guias: [
      {
        trofeos: ["Rematado"],
        titulo: "Ubicación de los 100 fragmentos de datos del Animus",
        descripcion:
          "Los fragmentos de datos están repartidos por toda Constantinopla (Galata, Distrito Imperial, Bayezid y más), sueltos en tejados, vigas y cornisas. Con 100 unidades es poco práctico anotarlos uno por uno en texto: conviene apoyarse en un mapa interactivo que los marque todos y permita ir tachándolos por distrito.",
        enlace: {
          texto: "Ver mapa interactivo con los 100 fragmentos en MapGenie",
          url: "https://mapgenie.io/assassins-creed-revelations/guides/data-fragments",
        },
      },
      {
        trofeos: ["Vale más que mil palabras"],
        titulo: "Ubicación de las 10 páginas de las memorias de Ishak Pasha",
        descripcion:
          "Son 10 páginas escondidas por Constantinopla que hay que recoger para completar las memorias de Ishak Pasha; a diferencia de los fragmentos de datos, son mucho más fáciles de pasar por alto porque hay muy pocas y están bien camufladas en el escenario.",
        enlace: {
          texto: "Ver mapa interactivo con las 10 páginas en MapGenie",
          url: "https://mapgenie.io/assassins-creed-revelations/guides/memoir-pages",
        },
      },
    ],
    trofeos: [
      { tier: "platino", nombre: "El conquistador", desc: "Conseguir todos los trofeos." },

      { tier: "bronce", nombre: "Los primeros años", desc: "Terminar la secuencia de Desmond 1." },
      { tier: "plata", nombre: "Servir preferentemente frío", desc: "Terminar la secuencia de ADN 1." },
      { tier: "bronce", nombre: "El Asesino reacio", desc: "Terminar la secuencia de Desmond 2." },
      { tier: "plata", nombre: "Estambul y Constantinopla", desc: "Terminar la secuencia de ADN 2." },
      { tier: "bronce", nombre: "Huida a Nueva York", desc: "Terminar la secuencia de Desmond 3." },
      { tier: "plata", nombre: "Rematar la faena", desc: "Terminar la secuencia de ADN 3." },
      { tier: "plata", nombre: "El príncipe", desc: "Terminar la secuencia de ADN 4." },
      { tier: "plata", nombre: "La trama se complica", desc: "Terminar la secuencia de ADN 5." },
      { tier: "plata", nombre: "Éxitos y fracasos", desc: "Terminar la secuencia de ADN 6." },
      { tier: "bronce", nombre: "La manzana podrida", desc: "Terminar la secuencia de Desmond 4." },
      { tier: "plata", nombre: "Jefe viejo, jefe nuevo", desc: "Terminar la secuencia de ADN 7." },
      { tier: "plata", nombre: "Prioridades", desc: "Terminar la secuencia de ADN 8." },
      { tier: "bronce", nombre: "¿Eres Desmond Miles?", desc: "Terminar la secuencia de Desmond 5." },
      { tier: "oro", nombre: "Revelaciones", desc: "Terminar la secuencia de ADN 9." },
      { tier: "plata", nombre: "Gratos recuerdos", desc: "Alcanzar el 100% de sincronización en todas las secuencias." },

      { tier: "plata", nombre: "Sagrada sabiduría", desc: "Superar el nivel de reto de Santa Sofía." },
      { tier: "bronce", nombre: "Rematado", desc: "Reunir todos los fragmentos de datos del Animus." },
      { tier: "bronce", nombre: "Vale más que mil palabras", desc: "Recoger todas las páginas de las memorias de Ishak Pasha." },
      { tier: "bronce", nombre: "Pirómano", desc: "Cumplir todas las misiones de bombas." },
      { tier: "bronce", nombre: "General de despacho", desc: "Controlar todas las ciudades (salvo Rodas) a la vez en el juego de Defensa mediterránea." },
      { tier: "bronce", nombre: "Telón de acero", desc: "Realizar una defensa de guarida perfecta sin usar el cañón." },
      { tier: "bronce", nombre: "Asesino araña", desc: "Escalar Santa Sofía, del suelo al pináculo, en menos de 25 segundos." },
      { tier: "bronce", nombre: "Un amigo de verdad", desc: "Cumplir todos los retos de credo de facción de una sola facción." },
      { tier: "bronce", nombre: "Evasión de impuestos", desc: "Recuperar tu dinero de un recaudador de impuestos templario." },
      { tier: "plata", nombre: "El mentor", desc: "Conseguir que siete pupilos alcancen el grado de maestro Asesino." },
      { tier: "bronce", nombre: "Como un rayo", desc: "Matar a 5 guardias en 5 segundos solo con las hojas ocultas." },
      { tier: "bronce", nombre: "Exterminador", desc: "Asesinar a 50 guardias con la hoja oculta." },
      { tier: "bronce", nombre: "Fantasma", desc: "Pasar de un paracaídas a una tirolina." },
      { tier: "bronce", nombre: "Sabio", desc: "Reunir todos los libros disponibles." },
      { tier: "bronce", nombre: "Manos largas", desc: "Saquear a 50 guardias muertos con saqueo de ladrón." },
      { tier: "bronce", nombre: "Todos al hoyo", desc: "Tener a 10 guardias envenenados a la vez." },
      { tier: "bronce", nombre: "Ratonera", desc: "Matar a 5 guardias con un andamio tras aturdirlos con abrojos." },
      { tier: "bronce", nombre: "Loco de las manualidades", desc: "Elaborar 30 bombas." },
      { tier: "bronce", nombre: "Mi protegido", desc: "Conseguir que un pupilo alcance el grado de maestro Asesino." },
      { tier: "bronce", nombre: "Casi volando", desc: "Lanzarse en paracaídas desde la cima de la torre de Gálata directamente al Cuerno de Oro." },
      { tier: "bronce", nombre: "Silencioso pero letal", desc: "Matar a 3 guardias a la vez solo con cuchillos arrojadizos." },
      { tier: "bronce", nombre: "Puedo verte", desc: "Matar a 5 guardias mientras estás cubierto por una bomba de cortina de humo." },
      { tier: "bronce", nombre: "Baile del monstruo", desc: "Hacer que un guardia incapacite a 3 civiles mientras está envenenado." },
      { tier: "bronce", nombre: "Matón", desc: "Localizar y dar una paliza a Duccio." },

      { tier: "bronce", nombre: "Parte del credo", desc: "Realizar el salto de fe de iniciación (DLC The Lost Archive)." },
      { tier: "bronce", nombre: "Salta, dicen", desc: "Alcanzar el informe del Animus (DLC The Lost Archive)." },
      { tier: "bronce", nombre: "Entrar en el Animus", desc: "Entrar en la simulación del Animus (DLC The Lost Archive)." },
      { tier: "bronce", nombre: "Reunirse con el creador", desc: "Terminar el recuerdo cinco (DLC The Lost Archive)." },
      { tier: "plata", nombre: "El bucle", desc: "Experimentar el bucle (DLC The Lost Archive)." },
      { tier: "plata", nombre: "Encontrar todos los fragmentos", desc: "Encontrar todos los fragmentos para descifrar (DLC The Lost Archive)." },
      { tier: "plata", nombre: "Romper el bucle", desc: "Detener el bucle y escapar del ciclo (DLC The Lost Archive)." },
      { tier: "bronce", nombre: "Salvarse", desc: "Aterrizar en un bloque tras caer más de 25 metros (DLC The Lost Archive)." },
      { tier: "bronce", nombre: "Impresionar a Warren Vidic", desc: "Terminar la secuencia de pruebas del Animus sin fallar (DLC The Lost Archive)." },
      { tier: "bronce", nombre: "Cruzar Estigia sin morir", desc: "Atravesar el río Estigia sin fallar (DLC The Lost Archive)." },
    ],
  },
];
